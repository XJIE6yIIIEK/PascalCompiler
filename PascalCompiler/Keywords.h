...
const std::map<std::string, KeywordsType> keywordsDict = {{
	...
	{",", KeywordsType::Comma},
	{"^", KeywordsType::Pow},
	{";", KeywordsType::EndCommand},
	{"char", KeywordsType::Char},
	{"int", KeywordsType::Int},
	{"bool", KeywordsType::Bool},
	{"float", KeywordsType::Float},
	{"if", KeywordsType::If},
	{"do", KeywordsType::Do},
	{"of", KeywordsType::Of},
	{"or", KeywordsType::Or},
...
const std::map<KeywordsType, std::string> enumToKeywords = { {
	...
	{KeywordsType::Pow, "^"},
	{KeywordsType::EndCommand, ";"},
	{KeywordsType::Char, "char"},
	{KeywordsType::Int, "int"},
	{KeywordsType::Bool, "bool"},
	{KeywordsType::Float, "float"},
	{KeywordsType::If, "if"},
	{KeywordsType::Do, "do"},
	{KeywordsType::Of, "of"},
	{KeywordsType::Or, "or"},
